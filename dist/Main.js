...
var cashier = new Cashier_1.Cashier(Staff_1.StaffCategory.Cashier, 3, 'chantha', 40, Person_1.Gender.FEMALE, "884384832");
...
restaurant.hr.addStaff(manager, chef, cashier);
console.log(human);
...
// calendar
var start = new DateTime_1.DateTime(2022, 4, 18, 2);
var end = new DateTime_1.DateTime(2022, 4, 18, 8);
